...
Gem::Specification.new do |spec|
  ...
  spec.files = IO.popen(%w[git ls-files -z], chdir: __dir__, err: IO::NULL) do |ls|
    ls.readlines("\x0", chomp: true).reject do |f|
      (f == gemspec) ||
        f.start_with?(*%w[bin/ test/ spec/ features/ examples/ .git .github appveyor Gemfile Rakefile discordrb-webhooks.gemspec README.md LICENSE.txt CHANGELOG.md .yardopts .rspec .markdownlint.json])
    end
  end
  spec.bindir = "exe"
